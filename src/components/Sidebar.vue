<template>
    ...
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30" :class="sidebarOpen ? '' : 'hidden'" id="main-nav">
          ...
          <div class="w-full h-20 border-b flex px-4 items-center mb-8">
            <p class="font-semibold text-3xl text-blue-400 pl-4">Admin</p>
          </div>
          ...
          <div class="mb-4 px-4">
            <p class="pl-4 text-sm font-semibold mb-1">CATEGORIES</p>
            <router-link :to="{name: 'AddCategory'}" class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
